...
&\\
{\color{bluesol}\fontsize{50}{50}\selectfont Vol. I, No. 3}&\\
&\\
\rowcolor{csccccccc}
Nada é impossível:  Hamilton Cristóvão  & {\fontsize{50}{50}\selectfont 1}\\
\rowcolor{cscccccc}
Solução em ação: Mika Matías &  {\fontsize{50}{50}\selectfont 3}\\
\rowcolor{csccccc}
Matemática em engenharia: Algoritmo AES & {\fontsize{50}{50}\selectfont 4}\\
\rowcolor{cscccc}
Informática en ingeniería: Polinomios, parte I & {\fontsize{50}{50}\selectfont 14}\\
\rowcolor{csccc}
Novedades:  Sistema prepago energético &{\fontsize{50}{50}\selectfont 19}\\
\rowcolor{cscc}
Pensar jugando &  {\fontsize{50}{50}\selectfont 23}\\
\end{tabularx}}}
\end{document}
%%% Local Variables: 
%%% mode: latex
